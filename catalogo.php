...
<div class="row d-flex flex-wrap justify-content-center">
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Pedigree para perros Adultos raza pequeña x 2kg  </p>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Combo: Alimentos Pedigree Lleva 3, pagas 2 </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Wiskas Alimiento para tu gato sabor carne x 1,5kg </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Wiskas Alimiento para tu gato sabor Pavo x 85g </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Wiskas Alimiento Premium sabor Pollo en lata </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Royal Canin lo mejor para tu gato, para recién nacidos x 2kg </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Royal Canin lo mejor para tu gato, adultos domésticos x 2kg </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Bebederos para perros y gatos. Super prácticos! </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Comedero recargable para tu mascota </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Collar para perros con tachas. Varios colores </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Moños para gatos y cachorros</p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Mochila carrito para pasear a tu mascota</p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Mochilas para perros. Super práctica! </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Cuna para gatos o cachorros 1,2m x 0,5m </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
  ...
  <div class="card br-light col-xs-12 col-sm-5 col-lg-3">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Futones con motivos para gatos.Varios motivos! </p>
      <button type="button" class="btn btn-success">Ver producto</button>
    </div>
  </div>
