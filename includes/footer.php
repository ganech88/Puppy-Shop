  ...
  <div class="container">
    <div class="row algo">
      ...
      <!-- <div class="col-md-4">
          ...
          <div class="img">
            <img src="images/fac.png" class="img-fluid" alt="">
          </div>
          <div class="img">
            <img src="images/Tw.png" class="img-fluid" alt="">
          </div>
          <div class="img">
            <img src="images/instag.png" class="img-fluid" alt="">
          </div>
      </div> -->
      ...
      <!-- <div class="col-md-4 mb-5 mb-lg-0">
          ...
          <div class="actions">
              <input type="text" name="email" placeholder="" title="Ingresá tu correo" class="input-text required-entry validate-email">
